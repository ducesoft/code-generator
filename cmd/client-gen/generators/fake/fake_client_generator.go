...
import (
	...
	scheme "github.com/ducesoft/code-generator/cmd/client-gen/generators/scheme"
...
func PackageForGroup(gv clientgentypes.GroupVersion, typeList []*types.Type, clientsetPackage string, clientsetPath string, groupPackageName string, groupGoName string, inputPackage string, boilerplate []byte) generator.Package {
