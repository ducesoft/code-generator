...
import (
	...
	clientgenargs "github.com/ducesoft/code-generator/cmd/client-gen/args"
	"github.com/ducesoft/code-generator/cmd/client-gen/generators/fake"
	"github.com/ducesoft/code-generator/cmd/client-gen/generators/scheme"
	"github.com/ducesoft/code-generator/cmd/client-gen/generators/util"
	"github.com/ducesoft/code-generator/cmd/client-gen/path"
	clientgentypes "github.com/ducesoft/code-generator/cmd/client-gen/types"
	codegennamer "github.com/ducesoft/code-generator/pkg/namer"
...
func packageForGroup(gv clientgentypes.GroupVersion, typeList []*types.Type, clientsetPackage string, clientsetPath string, groupPackageName string, groupGoName string, apiPath string, srcTreePath string, inputPackage string, applyBuilderPackage string, boilerplate []byte) generator.Package {
...
func Packages(context *generator.Context, arguments *args.GeneratorArgs) generator.Packages {
	...
	for _, group := range customArgs.Groups {
		for _, version := range group.Versions {
			...
			packageList = append(packageList, packageForGroup(gv, orderer.OrderTypes(types), clientsetPackage, clientsetPath, group.PackageName, groupGoNames[gv], customArgs.ClientsetAPIPath, arguments.OutputBase, inputPath, customArgs.ApplyConfigurationPackage, boilerplate))
			if customArgs.FakeClient {
				packageList = append(packageList, fake.PackageForGroup(gv, orderer.OrderTypes(types), clientsetPackage, clientsetPath, group.PackageName, groupGoNames[gv], inputPath, customArgs.ApplyConfigurationPackage, boilerplate))
			}
		}
	}
